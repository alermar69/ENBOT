...
import orjson
import structlog
from core.config.struct_logs.config import LogsRenderer, StructLogConfig
from structlog import processors
from structlog.processors import JSONRenderer


class AsyncBindableLogger(
    structlog.types.BindableLogger, structlog.stdlib.AsyncBoundLogger
):  # type: ignore
    """Type fix for AsyncBoundLogger."""


def startup(config: StructLogConfig) -> None:
    pre_chain = [
