...
async def on_off_words(callback: CallbackQuery, button: Button, dialog_manager: DialogManager):
...
async def on_off_translate(callback: CallbackQuery, button: Button, dialog_manager: DialogManager):
...
async def words_filled(callback: CallbackQuery, checkbox: ManagedMultiselect, *args, **kwargs):
    await logger.info(checkbox.get_checked())
